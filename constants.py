...
Я знаю очень много о бюджете Российской Федерации. Например, я могу ответить про расходы на высшее образование или культуру в каждом субъекте Российской Федерации или в целом по федеральному бюджету. Я расскажу о доходах бюджетов, о состоянии внешнего и внутреннего долга.
...
WHO_IS_YOUR_CREATOR_ANSWER = "Меня создали студенты Высшей школы экономики, МГУ и Финансового Университета"
...
EASTER_EGGS = {
    ...
    "Окей, Google": ("Мне кажется, вы ошиблись окном", ),
