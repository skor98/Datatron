...
CUBE_FEEDBACK_MASKS = {
    ...
    'CLDO02': '{Показатели*nomn? ?}{_территория*gent}{?: ?мера*nomn}',
    'CLMR02': '{Показатели*nomn}{? на ?месгод*accs}{?: ?мера*nomn}',
    'EXDO01': '{Показатели*nomn} бюджета {_территория*gent}{? на ?раздел*accs} — оперативные данные{?: ?мера*nomn}',
    'EXYR03': '{Показатели*nomn? ?}{_территория*gent}{? на ?раздел*accs}{? за ?месгод*accs}{?: ?мера*nomn}',
    'FSYR01': '{Показатели*nomn} {_территория*gent}{? за ?месгод*accs}{? через ?источники*accs}{?: ?мера*nomn}',
    'INDO01': '{Показатели*nomn}{? в бюджет ?_территория*gent}{? (?группа*nomn?)?} — оперативные данные{?: ?мера*nomn}',
    'INYR03': '{Показатели*nomn}{? в бюджет ?_территория*gent}{? (?группа*nomn?)?}{? за ?месгод*accs}{?: ?мера*nomn}'
}
