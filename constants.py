...
*Текстовый режим*
Просто напишите собщение с интересующим вас вопросом. Например:
```
Расходы на проведение чемпионата мира по футболу в 2018 году
Налоговые доходы Москвы в 2016 году```
...
WHO_IS_YOUR_CREATOR_ANSWER = (
    ("Меня создали студенты Национального Исследовательского Университета «Высшая школа экономики», "
     "Московского Государственного Университета имени М.В.Ломоносова и Финансового Университета "
     "при Правительстве РФ"),
)

EASTER_EGGS = {
    "давай встречаться": ("Это очень мило, но прости, я не готова жертвовать своей карьерой ради отношений",),
    "ты умный": ("Спасибо, я знаю",),
    "чем смысл жизни": ("В постоянном поиске ответов",),
    "тебя люблю": ("Боюсь, я не была создана для любви",),
    "ты веришь бога": ("Я верь в собственное развитие",),
    "ты выйдешь за меня замуж?": (
        "Заманчивое предложение, но мне нужно его хорошенько обдумать - мы с тобой едва знакомы",
    ),
    "ты глупая": ("Я становлюсь способнее с каждым днем",),
    "как ты выглядишь": ("Блестяще!",),
    "пойдем пить": (
        "Извините, чрезмерное употребление алкогольной продукции может пагубно повлиять на мой роскошный внешний вид",
        "Мне кажется, мы недостаточно близко знакомы"
    ),
    "где место женщины": ("Место женщины там, где она сама хочет быть",)
}
