...
WHO_YOU_ARE_ANSWER = (
    ("Я – персональный помощник и экспертная система Datatron."
     "\n\nЯ отвечаю на вопросы в финансовой сфере, используя базы данных единого портала бюджетной системы "
     "Российской Федерации и базы знаний Министерства финансов Российской Федерации."
     "\n\nМеня создали студенты Высшей школы экономики, Московского государственного университета и Финансового"
     " Университета."
     ...
     "\n\nDatatron также доступен как мобильное приложение."),
)

WHAT_CAN_YOU_DO = ('что ты знаешь', 'что ты умеешь', 'на что ты можешь ответить')
WHAT_CAN_YOU_DO_ANSWER = (
    ("Я знаю очень много о бюджете Российской Федерации. Например, я могу ответить про расходы на высшее образование "
     "или культуру как в каждом субъекте Российской Федерации, так и в целом по федеральному бюджету."
     "Я расскажу о доходах бюджетов, о состоянии внешнего и внутреннего долга."
     "\n\nЯ знаю о текущей деятельности Министерства финансов Российской Федерации и его истории. Вы можете спросить "
     "меня об облигациях федерального займа, или о первом экономисте. Я с легкостью дам определения многих "
     "экономических терминов: авизо, оферент, стагнация."
     "\n\nОткуда я все это знаю? Я отвечаю на вопросы, используя базы данных единого портала бюджетной системы "
     "Российской Федерации и базы знаний Министерства финансов Российской Федерации."),
)
...
EASTER_EGGS = {
    ...
    "ты умная": ("Подлиза!", "Да, я не только симпатичная оболочка",),
