...
<b>Текстовый режим</b>
Просто напишите ваш запрос на естественном языке. Например:
<code>внутренний долг в 2016 году
дефицит Ярославской области</code>

<b>Голосовой режим</b>
Воспользуйтесь встроенной в Telegram записью голоса.'''
ABOUT_MSG = '''<b>Описание:</b>
...
<i><b>Подробное описание доступных функций доступно по команде /help</b></i>'''
...
HELP_MSG = '''<b>Список доступных команд при взаимодействии с ботом:</b>

/start --- начало работы с ботом
/about --- о проекте
/fb --- оставить свой отзыв
/help --- отобразить эту памятку

Для поиска финансовой информации в базе достаточно просто сформулировать свой запрос и отправить его боту, например:
    
<code>бюджет Ярославской области в 2014 году</code>
...
Чтобы пользоваться ботом в инлайн-режиме и иметь возможность пользоваться его подсказками в любой другой переписке, нажмите на кнопку ниже.'''
...
MSG_LEAVE_YOUR_FEEDBACK = 'Напишите после команды /fb ваш отзыв. \nНапример: <code>' \
                          '/fb Вы классные, мне нравится, что...</code>'
