...
CUBE_FEEDBACK_MASKS = {
    ...
    'CLDO02': '{Показатель*nomn} {Территория*gent}{?: ?мера*nomn}',
    'CLMR02': '{Показатели*nomn} РФ на {месяц*accs}{? ?год? года?}{?: ?мера*nomn}',
    'EXDO01': '{Показатели*nomn} бюджета {Территория*gent}{? на ?раздел*accs} — оперативные данные{?: ?мера*nomn}',
    'EXYR03': '{Показатели*nomn} {Территория*gent}{? на ?раздел*accs}{? (?код*nomn?)?}{? за ?год? год?}{?: ?мера*nomn}',
    'FSYR01': '{Показатели*nomn} {Территория*gent}{? за ?год? год?}{? через ?источники*accs}{?: ?мера*nomn}',
    'INDO01': '{Показатели*nomn} в бюджет {Территория*gent}{? по ?группа*datv} — оперативные данные{?: ?мера*nomn}',
    'INYR03': '{Показатели*nomn} в бюджет {Территория*gent}{? по ?группа*datv}{? за ?год? год?}{?: ?мера*nomn}'
}